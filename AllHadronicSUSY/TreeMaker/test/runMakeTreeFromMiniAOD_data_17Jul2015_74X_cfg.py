...
global_tag = parameters.value("global_tag","74X_dataRun2_Prompt_v1")
...
jecfile=parameters.value("jecfile","Summer15_50nsV4_DATA")
#residual=parameters.value("residual",False)
residual=parameters.value("residual",True)
