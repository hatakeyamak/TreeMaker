...
residual=False,
    ...
    if len(jecfile)>0:
        ...
        JECPatch = cms.string('sqlite_fip:AllHadronicSUSY/TreeMaker/data/'+jecfile+'.db')
...
#            'HLT_IsoMu20_eta2p1_v',
            ...
            'HLT_L2Mu10_v',
            'HLT_Mu10_CentralPFJet30_BTagCSV0p54PF_v',
